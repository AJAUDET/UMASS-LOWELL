...
class Date {
 public:
	...
	void outputDateAsString2(ostream& out, Date date);
...
void Date::outputDateAsString2(ostream& out, Date date) {
	out << date.getMonthasString2() << " ";
	out << date.getDay() << ", ";
	out << date.getYear() << endl;
}
...
int main() {
	...
	cout << "d1 == "; d1.outputDateAsString2(cout, d1);
	cout << "d2 == "; d2.outputDateAsString2(cout, d2);

	d3.setMonth(4);
	cout << "d3 == "; d3.outputDateAsString2(cout, d3);
	
	Date d4(31, 12, 2018);
	d4.outputDateAsInt(cout, d4);
	d4.outputDateAsString(cout, d4);
	d4.outputDateAsString2(cout, d4);
