...
std::vector<int> EDistance::computeForward(const std::string& a, int aStart,
                                           int aEnd, const std::string& b,
                                           int bStart, int bEnd) {
  int n = bEnd - bStart;
...
std::vector<int> EDistance::computeBackward(const std::string& a, int aStart,
                                            int aEnd, const std::string& b,
                                            int bStart, int bEnd) {
  int n = bEnd - bStart;
  std::vector<int> prev(n + 1), curr(n + 1);
...
void EDistance::hirschberg(const std::string& a, int aStart, int aEnd,
